...
edit("src/ui/components/TitleBar.tsx", [{ find: ">zuno_<", replace: `>${brand.binary}_<` }]);
...
// The Zuno intro animation on the loading screen becomes the Muses mark.
edit("src/ui/components/AppLoadingScreen.tsx", [
  { find: 'import introVideo from "../../../assets/img/zuno.mp4";', replace: 'import musesMark from "../../../muses/icon.svg";' },
  {
    find: /<motion\.video[\s\S]*?<\/motion\.video>/,
    replace: `<motion.img
  initial={{ opacity: 0, scale: 0.92 }}
  animate={{ opacity: 1, scale: 1 }}
  transition={{ type: "spring", stiffness: 260, damping: 24 }}
  className="size-18 rounded-2xl drop-shadow-2xl"
  src={musesMark}
  alt=""
/>`,
  },
